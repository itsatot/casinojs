 ...
 *
 * #### Purpose
 * The `PokerPlayerEvents` enum is designed to provide a standardized reference for seat-related events in the game.
...
enum PokerPlayerEvents {
   ...
   * ```
   */
  INITIALIZED = "PokerPlayer:Initialized",
}

export { PokerPlayerEvents };
