 ...
 * ```
 */
class Casino extends _base_1.BaseEventEmitter {
    /**************************************************************************************************************
    ...
    _setRooms(rooms) {
        this.__rooms = rooms;
        this.emit(enums_1.CasinoEvents.ROOMS_SET, this.getRooms());
    ...
    _createRoom(config) {
        ...
        this.emit(enums_1.CasinoEvents.ROOM_CREATED, room);
        return room;
    }
    /**
     * #### Description
    ...
    _addRoom(room) {
        this.__rooms.push(room);
        this.emit(enums_1.CasinoEvents.ROOM_ADDED, this.getRooms());
        return this.getRooms();
    }
    /**
     * #### Description
    ...
    _deleteRoom(index) {
        if (this.isValidIndex(index)) {
            ...
            this.emit(enums_1.CasinoEvents.ROOM_DELETED, this.getRooms());
        }
        return this.getRooms();
    }
}
