 ...
 * ```
 */
class PokerPhase extends _base_1.BaseEventEmitter {
    /**************************************************************************************************************
    ...
    constructor(config) {
         ...
         * ```
         */
        this.__name = enums_1.PokerPhaseName.PRE_FLOP;
        /**
    ...
    __init(config) {
        if (config) {
            this.__name = config.name ?? enums_1.PokerPhaseName.PRE_FLOP;
            this.__deck = config.deck ?? new deck_1.Deck();
