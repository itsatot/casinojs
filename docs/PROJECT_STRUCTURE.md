...
│   │   ├── /card                         # Card model representing a playing card
│   │   │   └── index.ts                  # Card model implementation
│   │   ├── /deck                         # Deck model representing a deck of playing cards
│   │   │   └── index.ts                  # Deck model implementation
